...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage image = fsImageManager.loadImage(new File("resources/car.jpg"));
        ...
        fsImageManager.saveImage(grayscaleImage, new File("resources/car-grayscale.jpg"));
        fsImageManager.saveImage(edgeDetectedImage, new File("resources/car-edge-detected.jpg"));
    }
