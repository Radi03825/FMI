...
public class MJTOlympics implements Olympics {
    ...
    public void updateMedalStatistics(Competition competition) {
        ...
        for (int i = 0; i < topN; i++) {
            ...
            Medal medal = Medal.values()[Medal.values().length - i - 1];
    ...
    private void addAllCompetitorsToMedalTable() {
        for (Competitor competitor : registeredCompetitors) {
            nationsMedalTable.putIfAbsent(competitor.getNationality(), null);
        }
    }
