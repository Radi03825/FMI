...
public class Main {
    ...
    public static void main(String... args) throws FileNotFoundException {
        ...
        HashMap<Integer, List<Double>> objectObjectHashMap = new HashMap<>();
        List<Double> o = objectObjectHashMap.get(1);
        ...
        System.out.println(analyzer.allAccountIDs().size());
        System.out.println(analyzer.allAccountIDs().getFirst());
