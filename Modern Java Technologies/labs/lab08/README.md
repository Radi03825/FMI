...
![Variance formula](images/08.3-variance-formula.png)

където *μ* е средната стойност, т.е.

![Average value formula](images/08.4-average-value-formula.png)
...
![Standard deviation formula](images/08.5-standard-deviation-formula.png)
...
![Z-score formula](images/08.6-z-score-formula.png)
