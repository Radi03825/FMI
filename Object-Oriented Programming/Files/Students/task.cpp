...
void saveGroupToFile(ofstream& file, Group& group) {
    ...
    file << "First Name,Second Name,Faculty Number,Grade,Hair Color" << endl;
...
int main() {
    ...
    Student s1 = {"Alfred", "Segall", "12345", 5.2, BLACK};
    Student s2 = {"Robert", "Malone", "23456", 5.5, BLONDE};
    Student s3 = {"Jenny", "Kellam", "34567", 4.7, BLONDE};
